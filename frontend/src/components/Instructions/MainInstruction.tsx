...
const mainInstruction = [
  {
    ...
    content: [
      {
        description:
          "Choose how you want to play! The Home Page lets you pick between Solo Battle or Multiplayer Mode. Before continuing, you must enter your name — without it you cannot proceed.",
        bullet: [
  ...
  },
  {
    ...
    content: [
      {
        description:
          "Battle the computer with your own custom team. Once you enter your name, you can start immediately.",
        bullet: [
  ...
  },
  {
    ...
    content: [
      {
        description:
          "Challenge your friends in real time. After entering your name, choose whether to create a game or join one.",
        bullet: [
