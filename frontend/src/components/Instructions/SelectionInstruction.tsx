...
const selectionInstruction = [
    ...
    content: [
      {
        ...
        bullet: ["Top: Action Buttons", "Left: Your Pokemon Team", "Right: Pokemon Selection Library"],
  ...
  },
  {
    ...
    content: [
      {
        description:
          "Your chosen Pokemon appear here. A blue name marks your current Starter (the first to enter battle).",
        bullet: [
    ...
    content: [
      {
        ...
        bullet: ["Need later generations? Use the search bar to find them by name."],
