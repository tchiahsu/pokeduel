...
const TeamButton = ({ label, onClick, color, disabled }: TeamButtonProps) => {
    return (
        <button
            className={clsx(
                "pointer-events-auto cursor-pointer flex justify-center items-center text-[8px] rounded-full w-full h-1/3 p-2 transition-opacity duration-400 ease-in-out hover:scale-105 opacity-0 group-hover:opacity-100",
                {
