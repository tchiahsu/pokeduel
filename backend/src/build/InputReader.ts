...
export default class InputReader {
    ...
    async getPlayerTeamChoice(player: number): Promise<string[]> {
        const teamString = await this.prompt(`Player ${player}, choose your team of 6 Pokemons (separated by a space): `)
